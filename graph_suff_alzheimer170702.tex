...
%% Last-Updated: 2017-09-08T23:40:55+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
\newif\ifafour
...
citecolor=mypurpleblue,linkbordercolor={0.2666 0.4666 0.6666},%greenish
linkcolor=myredpurple,urlbordercolor={0.9333 0.4 0.4666},%reddish
...
\put(245,176){\makebox(0,0){\rotatebox{90}{\tiny\color{mygrey}\textsf{This
            document is typographically designed for screen reading and
            two-up printing on A4 or Letter paper}}}}%
\end{picture}}% A4
\else\newcommand\addprintnote{\begin{picture}(0,0)%
\put(176,132){\makebox(0,0){\rotatebox{90}{\tiny\color{mygrey}\textsf{This
            document is typographically designed for screen reading and
            two-up printing on A4 or Letter paper}}}}%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%   T H E   T E X T   S T A R T S   H E R E   %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% – final discussion, possibly: relation and \enquote{validation} with nonparametrics
...
%  \land (\yH_{i}^{\yh_{i}} \land \yF_{i}^{\yf_{i}})
%  \Land_{\yih} (\yH_{\yih}^{\yh} \land \yF_{\yih}^{\yf_{\yih}})
%  \Land_{\yihb} (\yH_{\yihb}^{\yh} \land \yF_{\yihb}^{\yf_{\yihb}})
%  \dotsb \land
  \yI \bigr).
\end{equation}
...
the form \mynote{The formula below has to be corrected: we cannot assume
  exchangeability for the probability for the health condition (incidence
  of diseases may increase or decrease in time, for example). But, given
  the individuals having the same health condition, we can assume
  exchangeability for the probability for the fMRI data}
\begin{equation}
...
\includegraphics[width=0.49\linewidth]{suf12.png}%
...
\begin{figure}[!h]
  \centering
figure%\includegraphics[width=\linewidth]{stds_6_params.pdf}%
...
\begin{figure}[!h]
  \centering
figure%\hfill\includegraphics[width=0.3\linewidth]{nodesize_vs_modularity3D.pdf}\\%
