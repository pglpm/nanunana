...
%% Last-Updated: 2017-08-24T13:54:54+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
\newif\ifafour
...
individual $3$ was healthy, $\yH_3=\yh$, and had fMRI data $\yF_3=\bm{}$; and
that individual $7$ had Alzheimer, $\yH_7=\ya$, and had fMRI data
$\yF_7=\bm{}$. What matter is that we have observed the specific pairs
$(\yh,\bm{})$ and $(\ya,\bm{})$; whether the individual of the first pair was
...
could be performed, would automatically eliminate the redundant information
...
that the connection and correlation between brain should be affected and
different from a healthy condition. This suggests reducing fMRI data to a
manageable set of graph properties, and apply our inference directly on
these. \mynote{formulate better. Does this statement make sense?}


\mynote{against pre-processing of data: Jaynes
\citey[\sect~17.10]{jaynes1994_r2003} shows that de-trending and seasonal
adjustment are approximations of the full probability calculation from the
original data. Bretthorst \citey{bretthorst1988} shows the same about
Fourier transforms}
