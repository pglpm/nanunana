...
%% Last-Updated: 2017-08-23T12:04:42+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
\newif\ifafour
...
of $(\yH,\yx)$; $\pf(\yp \|\yI)$ is a \enquote{hyperdistribution},
...
If our data $\yD$ do not comprise a large number of individuals, the
hyperdistribution $\pf(\yp \|\yI)$ and therefore our assumptions $\yI$ have
an important weight in the determination of the
probability~\eqref{eq:goal_1st_exchangeability}.
