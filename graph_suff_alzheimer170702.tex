...
%% Last-Updated: 2017-08-22T11:54:36+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
\newif\ifafour
...
de~Finetti \citep{definetti1930,definetti1937,hewittetal1955} states that
the probability of observing $N$ individuals with health conditions $\yH_i$
and fMRI data $\yx_i$ must have the form
\begin{equation}
...
of $(\yH,\yx)$, and the integral is over all such probability distributions.



, in the sense that
individual \enquote{$3$}, say, could just as well have been labelled
\enquote{$7$}, and vice versa. Maybe the labels reflect the temporal order
in which the individuals were studied, yet we could shuffle them without
affecting our probability assessment.



This simple fact is very important

There is an important assumption, which greatly circumscribes our possible
