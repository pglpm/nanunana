...
%% Last-Updated: 2017-08-23T11:34:33+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
\newif\ifafour
...
\item The latter formula also tells us what is the theoretical limit by
  which an health condition $\yH_0$ can be identified from fMRI data
  $\yx_0$: if $\ypc(\yH_0\|\yx_0)$ is more or less uniform independently of
  $\yx_0$, for example, it means that fMRI data are of no use to
  differentiate the health condition of an individual. This result follows
