...
%% Last-Updated: 2017-06-01T16:15:30+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
onecolumn,oneside,a5paper,article,british]{memoir}
\newif\ifnotnotes
...
\newcommand*{\pdfauthor}{C. Bachmann, P.G.L.  Porta Mana, A. Morrison}
...
\providecommand{\affiliation}[1]{\textsl{\textsf{\scriptsize #1}}}
\providecommand{\epost}[1]{\textnormal{\texttt{\scriptsize\textless#1\textgreater}}}
...
{\protect\centering C. Bachmann\\
  \epost{\email{c.bachmann}{fz-juelich.de}}\\
    \affiliation{Forschungszentrum J{\"u}lich INM-6}\\[-1\jot]\affiliation{Germany}}%
%  \hspace*{\stretch{1}}
  \parbox[t]{0.33\linewidth}%
{\protect\centering P.G.L.\ Porta\,Mana\\
  ...
  % \hspace*{\stretch{1}}
\parbox[t]{0.33\linewidth}%
{\protect\centering A. Morrison\\
  \epost{\email{a.morrison}{fz-juelich.de}}\\
    \affiliation{Forschungszentrum J{\"u}lich INM-6}\\[-1\jot]\affiliation{Germany}}%
  % \hspace*{\stretch{1}}
  \else Luca\fi
}
...
\emph{exchangeablitiy}, which simply say that the data of the subjects are
all equally important. But the calculation of the resulting probabilities is
computationally unmanageable at present.

A computationally feasible approach is to make the additional working
hypothesis that only specific features of the graph data -- their first and
